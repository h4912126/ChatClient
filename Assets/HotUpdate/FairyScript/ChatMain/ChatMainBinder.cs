...
namespace ChatMain
{
    public class ChatMainBinder
    {
        public static void BindAll()
        {
            UIObjectFactory.SetPackageItemExtension(UI_itemChatPage.URL, typeof(UI_itemChatPage));
            UIObjectFactory.SetPackageItemExtension(UI_itemAddFriendLine.URL, typeof(UI_itemAddFriendLine));
            UIObjectFactory.SetPackageItemExtension(UI_itemUserInfo.URL, typeof(UI_itemUserInfo));
            UIObjectFactory.SetPackageItemExtension(UI_itemChat.URL, typeof(UI_itemChat));
            ...
            UIObjectFactory.SetPackageItemExtension(UI_itemChatContent.URL, typeof(UI_itemChatContent));
        }
    }
}